export const AppTexts = {
  ...
  modals: {
    ...
    quickReport: {
      ...
      description: {
        found:
          "כיוון שציינתם שזיהיתם את כלבם, המערכת יצרה עבורכם טופס דיווח מקוצר. על מנת שנוכל לחבר בינכם לבין מי שמצא את הכלב, נצטרך שתמלאו את מספר הטלפון, לצורך קישור בווטסאפ.",
        lost: "כיוון שציינתם שזיהיתם את כלב שמצאתם, המערכת יצרה עבורכם טופס דיווח מקוצר. על מנת שנוכל לחבר בינכם לבין מי שאיבד את הכלב, נצטרך שתמלאו את מספר הטלפון, לצורך קישור בווטסאפ.",
      },
      goBackText: "חזרה",
      submitText: "שלח דיווח",
